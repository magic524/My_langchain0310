"""PyQt window for the first contract review GUI version."""
...
class PipelineWorker(QObject):
    ...
    def run(self) -> None:
        """Execute the service call and stream updates back to the UI."""
...
class ContractReviewMainWindow(QMainWindow):
    """Main window for the contract review GUI."""
    ...
    def _build_right_panel(self) -> QWidget:
        ...
        self.extra_prompt_edit.setPlaceholderText("例如：重点关注付款、违约责任、知识产权归属。")
        ...
        input_layout.addWidget(QLabel("额外要求"), 2, 0)
