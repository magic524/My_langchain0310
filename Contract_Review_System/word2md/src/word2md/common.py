...
# `common.py` lives under
# `<repo>/Contract_Review_System/word2md/src/word2md/common.py`.
# We want the monorepo root `<repo>` so relative CLI paths like
# `data/...` and `Contract_Review_System/...` resolve consistently.
REPO_ROOT = SCRIPT_DIR.parents[3]
DEFAULT_INPUT_DIR = REPO_ROOT / "data" / "合同数据-2026.3.12"
DEFAULT_OUTPUT_DIR = REPO_ROOT / "data" / "contract_review_outputs" / "word2md"
